...
inline bool operator==(const FloatOrPercent &l, const FloatOrPercent &r) noexcept
{
...
// When parsing a configuration value, if the old_value is not understood by this preFlight version,
// it is being substituted with some default value that this preFlight could work with.
...
public:
    ...
    {
        throw BadOptionTypeException("Calling ConfigOption::getInt on a non-int ConfigOption");
    }
    virtual std::vector<int> getInts() const
    {
        throw BadOptionTypeException("Calling ConfigOption::getInts on a non-ints ConfigOption");
    }
    virtual double getFloat() const
    {
        throw BadOptionTypeException("Calling ConfigOption::getFloat on a non-float ConfigOption");
    }
    virtual bool getBool() const
    {
        throw BadOptionTypeException("Calling ConfigOption::getBool on a non-boolean ConfigOption");
    }
    virtual void setInt(int /* val */)
    {
        throw BadOptionTypeException("Calling ConfigOption::setInt on a non-int ConfigOption");
    }
...
{
    using NilType = T;
    static constexpr auto value = static_cast<std::underlying_type_t<T>>(
...
template<class T>
using NilType = typename NilValueTempl<remove_cvref_t<T>>::NilType;
...
template<class T>
static constexpr NilType<T> NilValue() noexcept
{
    return NilValueTempl<remove_cvref_t<T>>::value;
}
...
public:
    ...
    bool is_nil() const override { return std::isnan(this->value); }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionSingle<double, NULLABLE>>(this));
    }
};
...
public:
    ...
    {
        return vectors_equal(this->values, rhs.values);
    }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionVector<double>>(this));
    }
};
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionSingle<int, NULLABLE>>(this));
    }
};
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionVector<int>>(this));
    }
};
...
public:
    ...
    std::vector<std::string> vserialize() const override { return this->values; }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionFloat>(this));
    }
};
...
public:
    ...
    explicit ConfigOptionPercentsTempl(std::initializer_list<double> il)
        : ConfigOptionFloatsTempl<NULLABLE>(std::move(il))
    {
    }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionFloatsTempl<NULLABLE>>(this));
    }
};
...
public:
    ...
    explicit ConfigOptionFloatsOrPercentsTempl(size_t n, FloatOrPercent value)
        : ConfigOptionVector<FloatOrPercent>(n, value)
    {
    }
    explicit ConfigOptionFloatsOrPercentsTempl(std::initializer_list<FloatOrPercent> il)
        : ConfigOptionVector<FloatOrPercent>(std::move(il))
    {
    }
    explicit ConfigOptionFloatsOrPercentsTempl(const std::vector<FloatOrPercent> &vec)
        : ConfigOptionVector<FloatOrPercent>(vec)
    {
    }
    explicit ConfigOptionFloatsOrPercentsTempl(std::vector<FloatOrPercent> &&vec)
        : ConfigOptionVector<FloatOrPercent>(std::move(vec))
    {
    }
    ...
    bool operator<(const ConfigOptionFloatsOrPercentsTempl &rhs) const throw()
    {
        return vectors_lower(this->values, rhs.values);
    }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionVector<FloatOrPercent>>(this));
    }
};
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionSingle<Vec2d>>(this));
    }
};
...
public:
    ...
    {
        return std::lexicographical_compare(this->values.begin(), this->values.end(), rhs.values.begin(),
                                            rhs.values.end(), [](const auto &l, const auto &r) { return l < r; });
    }
    bool is_nil(size_t) const override { return false; }
...
public:
        ...
        return this->value.x() < rhs.value.x() ||
               (this->value.x() == rhs.value.x() &&
                (this->value.y() < rhs.value.y() ||
                 (this->value.y() == rhs.value.y() && this->value.z() < rhs.value.z())));
    }
    ...
    bool deserialize(const std::string &str, bool append = false) override
    {
        ...
        return sscanf(str.data(), " %lf , %lf , %lf %c", &this->value(0), &this->value(1), &this->value(2), &dummy) ==
                   3 ||
               sscanf(str.data(), " %lf x %lf x %lf %c", &this->value(0), &this->value(1), &this->value(2), &dummy) ==
                   3;
    }
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionSingle<Vec3d>>(this));
    }
};
...
private:
    ...
    void serialize(Archive &ar)
    {
        ar(cereal::base_class<ConfigOptionSingle<bool>>(this));
    }
};
...
public:
    ...
    explicit ConfigOptionBoolsTempl(std::vector<unsigned char> &&vec)
    ...
    bool deserialize(const std::string &str, bool append = false) override
    {
        return this->deserialize_with_substitutions(str, append,
                                                    ConfigHelpers::DeserializationSubstitution::Disabled) ==
               ConfigHelpers::DeserializationResult::Loaded;
    }
...
private:
    void serialize_single_value(std::ostringstream &ss, const int v) const { ss << v; }
};
...
public:
    ...
    explicit ConfigOptionEnumGeneric(const t_config_enum_values *keys_map, int value)
        : ConfigOptionInt(value), keys_map(keys_map)
    {
    }
...
public:
    ...
    explicit ConfigOptionEnumsGenericTempl(const t_config_enum_values *keys_map, std::vector<int> values)
        : keys_map(keys_map)
    {
        this->values = values;
    }
    ...
    explicit ConfigOptionEnumsGenericTempl(std::initializer_list<int> il)
        : ConfigOptionIntsTempl<NULLABLE>(std::move(il))
    {
    }
...
public:
    ...
    {
        return gui_type == ConfigOptionDef::GUIType::i_enum_open || gui_type == ConfigOptionDef::GUIType::f_enum_open ||
               gui_type == ConfigOptionDef::GUIType::select_open;
    }
    ...
    {
        return static_cast<const T *>(this->default_value.get());
    }
    ...
    ConfigOption *load_option_from_archive(Archive &archive) const
    {
        if (this->nullable)
        {
            ...
            default:
                throw ConfigurationError(
                    std::string(
                        "ConfigOptionDef::load_option_from_archive(): Unknown nullable option type for option ") +
                    this->opt_key);
            }
        }
        else
        {
            ...
            default:
                throw ConfigurationError(
                    std::string("ConfigOptionDef::load_option_from_archive(): Unknown option type for option ") +
                    this->opt_key);
            }
        }
    }
    ...
    ConfigOption *save_option_to_archive(Archive &archive, const ConfigOption *opt) const
    {
        if (this->nullable)
        {
            ...
            case coBools:
                ...
                break;
            case coFloatsOrPercents:
                archive(*static_cast<const ConfigOptionFloatsOrPercentsNullable *>(opt));
                break;
            default:
                throw ConfigurationError(
                    std::string("ConfigOptionDef::save_option_to_archive(): Unknown nullable option type for option ") +
                    this->opt_key);
            }
        }
        else
        {
            ...
            default:
                throw ConfigurationError(
                    std::string("ConfigOptionDef::save_option_to_archive(): Unknown option type for option ") +
                    this->opt_key);
            }
        }
    ...
    void set_enum_values(GUIType gui_type,
    ...
    void set_enum_labels(GUIType gui_type, const std::initializer_list<std::string_view> il)
    {
        this->enum_def_new();
        assert(gui_type == GUIType::i_enum_open || gui_type == GUIType::f_enum_open ||
               gui_type == ConfigOptionDef::GUIType::select_close);
        this->gui_type = gui_type;
...
public:
    ...
    bool set_deserialize_nothrow(const t_config_option_key &opt_key_src, const std::string &value_src,
                                 ConfigSubstitutionContext &substitutions, bool append = false);
    ...
    struct SetDeserializeItem
    {
        ...
        SetDeserializeItem(const char *opt_key, const std::initializer_list<int> values, bool append = false)
            : opt_key(opt_key), opt_value(format(values)), append(append)
        {
        }
        SetDeserializeItem(const std::string &opt_key, const std::initializer_list<int> values, bool append = false)
            : opt_key(opt_key), opt_value(format(values)), append(append)
        {
        }
        ...
        SetDeserializeItem(const std::string &opt_key, const std::initializer_list<double> values, bool append = false)
            : opt_key(opt_key), opt_value(format(values)), append(append)
        {
        }
    ...
    {
        return const_cast<ConfigBase *>(this)->opt_string(opt_key);
    }
    ...
    {
        return const_cast<ConfigBase *>(this)->opt_string(opt_key, idx);
    }
    ...
    {
        return dynamic_cast<const ConfigOptionInt *>(this->option(opt_key))->value;
    }
    int &opt_int(const t_config_option_key &opt_key, unsigned int idx)
    {
        return this->option<ConfigOptionInts>(opt_key)->get_at(idx);
    }
    ...
    template<typename ENUM>
    ENUM opt_enum(const t_config_option_key &opt_key, unsigned int idx) const
    {
        return dynamic_cast<const ConfigOptionEnums<ENUM> *>(this->option(opt_key))->get_at(idx);
    }

    bool opt_bool(const t_config_option_key &opt_key) const
    {
        return this->option<ConfigOptionBool>(opt_key)->value != 0;
    }
    ...
    ConfigSubstitutions load_from_ini_string(const std::string &data,
    ...
    ConfigSubstitutions load_from_ini_string_commented(std::string &&data,
                                                       ForwardCompatibilitySubstitutionRule compatibility_rule);
    ConfigSubstitutions load_from_gcode_file(const std::string &filename,
                                             ForwardCompatibilitySubstitutionRule compatibility_rule);
    ConfigSubstitutions load_from_binary_gcode_file(const std::string &filename,
                                                    ForwardCompatibilitySubstitutionRule compatibility_rule);
    ConfigSubstitutions load(const boost::property_tree::ptree &tree,
                             ForwardCompatibilitySubstitutionRule compatibility_rule);
    ...
    static size_t load_from_gcode_string_legacy(ConfigBase &config, const char *str,
                                                ConfigSubstitutionContext &substitutions);

private:
    // Set a configuration value from a string.
    bool set_deserialize_raw(const t_config_option_key &opt_key_src, const std::string &value,
                             ConfigSubstitutionContext &substitutions, bool append);
};
