...
///|/
#ifndef ARACHNE_slic3r_GCode_PerimeterOrder_hpp_
#define ARACHNE_slic3r_GCode_PerimeterOrder_hpp_
...
{
    explicit PerimeterExtrusion(const Arachne::ExtrusionLine &extrusion, const double area, const Polygon &polygon,
...
#endif // ARACHNE_slic3r_GCode_PerimeterOrder_hpp_
