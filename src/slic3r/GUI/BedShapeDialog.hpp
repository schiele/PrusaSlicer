...
struct BedShape
{
    ...
    bool is_custom()
    {
        return m_build_volume.type() == BuildVolume::Type::Convex || m_build_volume.type() == BuildVolume::Type::Custom;
    }
...
public:
    ...
    {
        return (m_custom_texture != NONE) ? m_custom_texture : EMPTY_STRING;
    }
