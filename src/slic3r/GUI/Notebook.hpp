...
{
public:
    Notebook(wxWindow *parent, wxWindowID winid = wxID_ANY, const wxPoint &pos = wxDefaultPosition,
                ...
                const wxSize &size = wxDefaultSize, long style = 0)
    {
        ...
        this->Bind(wxCUSTOMEVT_NOTEBOOK_SEL_CHANGED,
    ...
    // Page management
    virtual bool InsertPage(size_t n, wxWindow *page, const wxString &text, bool bSelect = false,
    ...
    bool InsertPage(size_t n, wxWindow *page, const wxString &text, const std::string &bmp_name = "",
                    bool bSelect = false)
    {
