...
public:
    ...
    void add_substitution(int substitution_id = -1, const std::string &plain_pattern = std::string(),
                          const std::string &format = std::string(), const std::string &params = std::string(),
...
public:
    ...
    virtual void update_sla_vendor_specific_visibility() {}
...
class TabFilament : public Tab
{
    ...
    void create_line_with_near_label_widget(ConfigOptionsGroupShp optgroup, const std::string &opt_key,
                                            int opt_index = 0);
    void update_line_with_near_label_widget(ConfigOptionsGroupShp optgroup, const std::string &opt_key,
...
private:
    ...
    wxButton *m_rrf_retrieve_btn{nullptr};
...
public:
    ...
    void update_rrf_retrieve_btn_state();

    wxSizer *create_bed_shape_widget(wxWindow *parent);
    void cache_extruder_cnt(const DynamicPrintConfig *config = nullptr);
    bool apply_extruder_cnt_from_cache();
    void update_sla_vendor_specific_visibility() override;
};
