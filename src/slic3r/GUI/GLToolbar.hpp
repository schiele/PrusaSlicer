...
public:
    ...
    void render(const GLCanvas3D &parent, unsigned int tex_id, float left, float right, float bottom, float top,
                unsigned int tex_width, unsigned int tex_height, unsigned int icon_size) const;
...
public:
    ...
    void set_horizontal_orientation(Layout::EHorizontalOrientation orientation)
    {
    ...
    void set_vertical_orientation(Layout::EVerticalOrientation orientation)
    {
    ...
    std::pair<float, float> get_item_center_position(const std::string &name, const GLCanvas3D &parent) const;
    void force_left_action(int item_id, GLCanvas3D &parent) { do_action(GLToolbarItem::Left, item_id, parent, false); }
    void force_right_action(int item_id, GLCanvas3D &parent)
    {
    ...
    bool is_any_item_visible() const;
