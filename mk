...
case "$*" in
	*dyn*)
	       DDIR="${DDIR}dyn"
	       BDIR="${BDIR}dyn"
	       DEPFLAGS="$DEPFLAGS -DPrusaSlicer_deps_PACKAGE_EXCLUDES:STRING=Blosc;Boost;Cereal;CGAL;CURL;Eigen;EXPAT;GLEW;GMP;JPEG;MPFR;NLopt;OCCT;OpenCSG;OpenEXR;OpenSSL;PNG;Qhull;TBB;TIFF;ZLIB"
